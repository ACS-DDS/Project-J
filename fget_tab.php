...
<?php endforeach; ?>
					...
					<td>
						...
						<input type="hidden" name="reference" value="<?=$types[0];?>" />
						<input type="hidden" name="matiere" value="<?=$types[1];?>" />
						<input type="hidden" name="longueur" value="<?=$types[2];?>" />
						<input type="hidden" name="largeur" value="<?=$types[3];?>" />
					</td>
				</tr>
			</form>
<?php
